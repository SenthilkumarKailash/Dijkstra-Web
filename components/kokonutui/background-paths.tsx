...
function FloatingPaths({ position }: { position: number }) {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none">
      <svg
        className="w-full h-full text-[#0a500a] dark:text-white"
        viewBox="0 0 696 316"
        fill="none"
      >
          ...
          <div className="w-full max-w-4xl text-center">
            ...
            {showButton && (
              <div className="flex justify-center mt-8">
                <div className="inline-block group relative bg-gradient-to-b from-black/10 to-white/10 dark:from-white/10 dark:to-black/10 p-px rounded-2xl backdrop-blur-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <Button
                    variant="ghost"
